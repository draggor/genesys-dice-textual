...
class ButtonPlus(Widget, can_focus=True):
    ...
    class Pressed(Message):
        ...
        def __init__(self, button: ButtonPlus) -> None:
            self.button: ButtonPlus = button
            """The button that was pressed."""
            super().__init__()

        @property
        def control(self) -> ButtonPlus:
    ...
    def press(self) -> Self:
        ...
        if self.action is None:
            self.post_message(ButtonPlus.Pressed(self))
        else:
            self.call_later(
